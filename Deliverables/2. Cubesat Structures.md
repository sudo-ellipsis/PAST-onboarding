...
The cubesat structure should do the job - that is, provide structural support, launcher rails and be workable. It does not need to look good or have absolutely perfect topography - in space, things have to work as the #1 priority.
